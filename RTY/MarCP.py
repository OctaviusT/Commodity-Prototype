...
if __name__ == "__main__":
    ...
    symbols = ["RTYH4","RTYM4"]  # Russell 2000 Futures symbol for February 2024
    start = "2024-03-01T00:00:00"  # Start date in ISO 8601 format
    end = "2024-03-31T23:59:59"    # End date in ISO 8601 format
    ...
    df.to_csv('rty_data_mar_2024.csv', index=False)  # Save to a new CSV file
    print("Data saved to rty_data_feb_2024.csv.")

    # Load the saved CSV file with no header
    df_loaded = pd.read_csv('rty_data_feb_2024.csv', header=None)
    ...
    output_file = 'RTY_Mar24_OHLCV.csv'
