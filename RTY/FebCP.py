...
if __name__ == "__main__":
    ...
    symbols = ["RTYH4"]  # Russell 2000 Futures symbol for February 2024
    ...
    df.to_csv('rty_data_feb_2024.csv', index=False)  # Save to a new CSV file
    ...
    output_file = 'RTY_Feb24_OHLCV.csv'
